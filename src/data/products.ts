...
export const categories: Category[] = [
  {
    ...
    products: [
      { name: l('Original', 'Original'), image: '/images/products/fish-cheese/original-30g.png', sizes: ['10g', '30g', '85g'], description: l('The honest pairing of savoury fish and creamy cheese.', 'Perpaduan jujur antara gurihnya ikan dan lembutnya keju.'), ingredients: l('Fresh fish, Australian parmesan cheese, tapioca, vegetable oil, salt.', 'Ikan segar, keju parmesan Australia, tapioka, minyak nabati, garam.'), gallery: ['/images/products/fish-cheese/original-10g.png', '/images/products/fish-cheese/original-30g.png', '/images/products/fish-cheese/original-85g.png'] },
      { name: l('Truffle', 'Truffle'), image: '/images/products/fish-cheese/truffle-30g.png', sizes: ['10g', '30g', '85g'], description: l('A gentle truffle finish for a tiny touch of luxury.', 'Sentuhan akhir truffle yang lembut untuk rasa istimewa.'), ingredients: l('Fresh fish, parmesan cheese, truffle seasoning, tapioca, vegetable oil, sea salt.', 'Ikan segar, keju parmesan, bumbu truffle, tapioka, minyak nabati, garam laut.'), gallery: ['/images/products/fish-cheese/truffle-10g.png', '/images/products/fish-cheese/truffle-30g.png', '/images/products/fish-cheese/truffle-85g.png'] },
      { name: l('Korean Garlic Chicken', 'Ayam Bawang Korea'), image: '/images/products/fish-cheese/korean-garlic-30g.png', sizes: ['10g', '30g', '85g'], description: l('Garlic, onion, cheese, sesame and real chicken stock in harmony.', 'Bawang putih, bawang bombai, keju, wijen, dan kaldu ayam asli yang harmonis.'), ingredients: l('Fresh fish, parmesan cheese, real chicken stock, onion, garlic, dried green onion, sesame seeds, tapioca.', 'Ikan segar, keju parmesan, kaldu ayam asli, bawang bombai, bawang putih, daun bawang kering, biji wijen, tapioka.'), gallery: ['/images/products/fish-cheese/korean-garlic-10g.png', '/images/products/fish-cheese/korean-garlic-30g.png', '/images/products/fish-cheese/korean-garlic-85g.png'] },
      { name: l('Pizza Margherita', 'Pizza Margherita'), image: '/images/products/fish-cheese/pizza-30g.png', sizes: ['10g', '30g', '85g'], description: l('Tomato, parmesan, mozzarella and basil—simple like a good pizza.', 'Tomat, parmesan, mozzarella, dan basil—sederhana seperti pizza yang lezat.'), ingredients: l('Fresh fish, parmesan, mozzarella, tomato powder, fresh basil, tapioca, vegetable oil.', 'Ikan segar, keju parmesan, mozzarella, bubuk tomat, basil segar, tapioka, minyak nabati.'), gallery: ['/images/products/fish-cheese/pizza-10g.png', '/images/products/fish-cheese/pizza-30g.png', '/images/products/fish-cheese/pizza-85g.png'] },
    ],
  },
  {
  ...
  },
  {
    ...
    products: [
      { name: l('Cappuccino Chips', 'Keripik Cappuccino'), image: '/images/products/cappuccino/cappuccino-30g.png', sizes: ['30g', '60g'], description: l('Real coffee, caramel sauce and a sprinkle of Lotus Biscoff crumbs.', 'Kopi asli, saus karamel, dan taburan remah Lotus Biscoff.'), ingredients: l('100% real coffee beans, caramel drizzle, Lotus Biscoff crumbs, tapioca, vegetable oil.', '100% biji kopi asli, saus karamel, remah Lotus Biscoff, tapioka, minyak nabati.'), gallery: ['/images/products/cappuccino/cappuccino-30g.png', '/images/products/cappuccino/cappuccino-60g.png'] },
    ],
  },
];
